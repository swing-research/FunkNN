...
interpolation_kernel = 'bilinear' # interpolation kernels : {'cubic_conv', 'bilinear', 'bicubic'}
...
derivatives_evaluation = True # To evaluate the performance of the model for computing the derivatives
